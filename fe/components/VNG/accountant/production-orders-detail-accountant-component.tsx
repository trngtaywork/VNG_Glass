...
interface ProductionOrdersDetailAccountantComponentProps {
    productionOrderId?: string;
    onProductUpdated?: () => void;
    onMaterialUpdated?: () => void;
}

const ProductionOrdersDetailAccountantComponent: React.FC<ProductionOrdersDetailAccountantComponentProps> = ({
    productionOrderId = '1',
    onProductUpdated,
    onMaterialUpdated
}) => {
